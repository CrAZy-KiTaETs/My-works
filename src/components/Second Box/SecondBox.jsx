...
const SecondBox = ({ secondActive, thirdActive }) => {
  const [projects, setProjects] = useState([
    ...
    },
    {
      ...
      text: "Этим проектом я хотел проверить и укрепить свои знания, моей задачей было как можно реже прибегать к помощи интернета из-за чего на самые банальные вещи уходило много времени потому что мне было важно самому во всем разобраться. Каждый шаг создания сайта давался мне с трудом, например селектор, оказалось, что нельзя кастомизировать стандартный селектор, поэтому я изучил SCSS и создал собственный. К концу проекта я стал лучше разбираться в хуках, пропсах, SCSS, деструктуризации, адаптивности, функциональных компонентах и DOOM дереве",
    },
    {
      id: 3,
      style: "project3",
